...
//            System.out.println(new String(key));
    ...
    public static byte[] encrypt(String strToEncrypt, String secret) {
        try {
            ...
            byte[] encryptData = cipher.doFinal(strToEncrypt.getBytes("UTF-8"));
            return encryptData;
        } catch (Exception e) {
    ...
    public static byte[] decrypt(String strToDecrypt, String secret) {
        try {
            ...
            byte[] encryptedData = Base64.getDecoder().decode(strToDecrypt.getBytes("UTF-8"));
